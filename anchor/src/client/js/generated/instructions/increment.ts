...
export type IncrementInput<TAccountProject2 extends string = string> = {
...
>(
  input: IncrementInput<TAccountProject2>,
  config?: { programAddress?: TProgramAddress }
): IncrementInstruction<TProgramAddress, TAccountProject2> {
  // Program address.
  ...
  } as IncrementInstruction<TProgramAddress, TAccountProject2>;
